  ...
  return (
    <div className="bg-[#F9F3E6]">
      ...
      <div className="flex flex-col items-center justify-center w-full font-poppins">
        <div className="w-[75vw] bg-[#1F293E] text-white px-8 sm:px-16 py-8 rounded-3xl my-10">
        ...
        <div className=" w-[75vw]  bg-[#C0C9DB] text-black px-8 sm:px-16 py-8 rounded-3xl ">
          <h1 className="text-center md:text-5xl text-3xl font-semibold mb-5">
            What we do
          </h1>
          <p className="md:text-2xl text-md ">
